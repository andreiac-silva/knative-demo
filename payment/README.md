...
This Service will approve purchase for customers with attribute cpf (see curl bellow) containing "123". Besides that, will load customer's name and e-mail into current event.
